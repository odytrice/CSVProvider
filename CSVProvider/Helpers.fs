...
let internal toDataTable (data: string [,]) =
    let table = new DataTable()
    let header = data.[0, *]

    let columns = header |> Array.mapi(fun i t -> new DataColumn(t, detectType data.[1.., i]))
